# This is a function to simulate from the posterior distribution of the model
# parameters of an epidemic using MCMC
...
mcmcSIR.Markov <- function(data, iter) {
	...
	# an easy way to place all the infection times just before the first removal
	# time.
